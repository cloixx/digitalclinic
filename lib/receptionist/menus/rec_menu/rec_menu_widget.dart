...
import 'rec_menu_model.dart';
export 'rec_menu_model.dart';

class RecMenuWidget extends StatefulWidget {
  const RecMenuWidget({
    super.key,
  ...
  @override
  State<RecMenuWidget> createState() => _RecMenuWidgetState();
}

class _RecMenuWidgetState extends State<RecMenuWidget> {
  late RecMenuModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RecMenuModel());
