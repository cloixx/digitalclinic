...
import 'dart:math';
import 'adm_patients_widget.dart' show AdmPatientsWidget;
...
class AdmPatientsModel extends FlutterFlowModel<AdmPatientsWidget> {
  ///  State fields for stateful widgets in this page.

  final unfocusNode = FocusNode();
  // Stores action output result for [Backend Call - Query Rows] action in adm_Patients widget.
