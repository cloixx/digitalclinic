...
import 'dart:math';
import 'adm_forms_and_statements_widget.dart' show AdmFormsAndStatementsWidget;
...
class AdmFormsAndStatementsModel
    extends FlutterFlowModel<AdmFormsAndStatementsWidget> {
  ///  State fields for stateful widgets in this page.

  final unfocusNode = FocusNode();
  // Stores action output result for [Backend Call - Query Rows] action in adm_FormsAndStatements widget.
