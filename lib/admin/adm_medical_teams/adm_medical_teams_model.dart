...
import 'dart:math';
import 'adm_medical_teams_widget.dart' show AdmMedicalTeamsWidget;
...
class AdmMedicalTeamsModel extends FlutterFlowModel<AdmMedicalTeamsWidget> {
  ///  State fields for stateful widgets in this page.

  final unfocusNode = FocusNode();
  // Stores action output result for [Backend Call - Query Rows] action in adm_MedicalTeams widget.
