...
import 'dart:math';
import 'adm_classifiers_widget.dart' show AdmClassifiersWidget;
...
class AdmClassifiersModel extends FlutterFlowModel<AdmClassifiersWidget> {
  ///  State fields for stateful widgets in this page.

  final unfocusNode = FocusNode();
  // Stores action output result for [Backend Call - Query Rows] action in adm_Classifiers widget.
