...
import 'adm_menu_model.dart';
export 'adm_menu_model.dart';

class AdmMenuWidget extends StatefulWidget {
  const AdmMenuWidget({
    super.key,
  ...
  @override
  State<AdmMenuWidget> createState() => _AdmMenuWidgetState();
}

class _AdmMenuWidgetState extends State<AdmMenuWidget> {
  late AdmMenuModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdmMenuModel());
                              ...
                              children: [
                                ...
                                MouseRegion(
                                  ...
                                  child: InkWell(
                                    ...
                                    highlightColor: Colors.transparent,
                                    onTap: () async {
                                      context.pushNamed('adm_Departments');
                                    },
                                    child: AnimatedContainer(
                                      duration: Duration(milliseconds: 200),
                                      curve: Curves.easeInOut,
                                ...
                                MouseRegion(
                                  ...
                                  child: InkWell(
                                    ...
                                    highlightColor: Colors.transparent,
                                    onTap: () async {
                                      context.pushNamed('adm_Notifications');
                                    },
                                    child: AnimatedContainer(
                                      duration: Duration(milliseconds: 200),
                                      curve: Curves.easeInOut,
                                ...
                                MouseRegion(
                                  ...
                                  child: InkWell(
                                    ...
                                    highlightColor: Colors.transparent,
                                    onTap: () async {
                                      context.pushNamed('adm_Patients');
                                    },
                                    child: AnimatedContainer(
                                      duration: Duration(milliseconds: 200),
                                      curve: Curves.easeInOut,
                                ...
                                MouseRegion(
                                  ...
                                  child: InkWell(
                                    ...
                                    highlightColor: Colors.transparent,
                                    onTap: () async {
                                      context.pushNamed('adm_MedicalTeams');
                                    },
                                    child: AnimatedContainer(
                                      duration: Duration(milliseconds: 200),
                                      curve: Curves.easeInOut,
                                ...
                                MouseRegion(
                                  ...
                                  child: InkWell(
                                    ...
                                    highlightColor: Colors.transparent,
                                    onTap: () async {
                                      context.pushNamed('adm_Interventions');
                                    },
                                    child: AnimatedContainer(
                                      duration: Duration(milliseconds: 200),
                                      curve: Curves.easeInOut,
                                ...
                                MouseRegion(
                                  ...
                                  child: InkWell(
                                    ...
                                    highlightColor: Colors.transparent,
                                    onTap: () async {
                                      context.pushNamed('adm_Classifiers');
                                    },
                                    child: AnimatedContainer(
                                      duration: Duration(milliseconds: 200),
                                      curve: Curves.easeInOut,
                                ...
                                MouseRegion(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      context
                                          .pushNamed('adm_FormsAndStatements');
                                    },
                                    child: AnimatedContainer(
                                      duration: Duration(milliseconds: 200),
                                      curve: Curves.easeInOut,
