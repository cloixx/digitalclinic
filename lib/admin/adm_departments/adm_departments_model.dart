...
import 'dart:math';
import 'adm_departments_widget.dart' show AdmDepartmentsWidget;
...
class AdmDepartmentsModel extends FlutterFlowModel<AdmDepartmentsWidget> {
  ///  State fields for stateful widgets in this page.

  final unfocusNode = FocusNode();
  // Stores action output result for [Backend Call - Query Rows] action in adm_Departments widget.
