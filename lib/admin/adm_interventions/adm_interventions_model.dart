...
import 'dart:math';
import 'adm_interventions_widget.dart' show AdmInterventionsWidget;
...
class AdmInterventionsModel extends FlutterFlowModel<AdmInterventionsWidget> {
  ///  State fields for stateful widgets in this page.

  final unfocusNode = FocusNode();
  // Stores action output result for [Backend Call - Query Rows] action in adm_Interventions widget.
