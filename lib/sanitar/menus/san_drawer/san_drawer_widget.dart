...
import 'san_drawer_model.dart';
export 'san_drawer_model.dart';

class SanDrawerWidget extends StatefulWidget {
  const SanDrawerWidget({
    super.key,
  ...
  @override
  State<SanDrawerWidget> createState() => _SanDrawerWidgetState();
}

class _SanDrawerWidgetState extends State<SanDrawerWidget> {
  late SanDrawerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SanDrawerModel());
