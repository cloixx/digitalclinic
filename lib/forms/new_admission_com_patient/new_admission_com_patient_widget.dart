...
import 'new_admission_com_patient_model.dart';
export 'new_admission_com_patient_model.dart';

class NewAdmissionComPatientWidget extends StatefulWidget {
  const NewAdmissionComPatientWidget({
    super.key,
    this.patientID,
  });
  ...
  @override
  State<NewAdmissionComPatientWidget> createState() =>
      _NewAdmissionComPatientWidgetState();
}

class _NewAdmissionComPatientWidgetState
    extends State<NewAdmissionComPatientWidget> {
  late NewAdmissionComPatientModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewAdmissionComPatientModel());
    ...
    _model.reqTextController ??= TextEditingController();
    ...
    _model.facilityTextController ??= TextEditingController();
    _model.facilityFocusNode ??= FocusNode();

    _model.facilityCodeTextController ??= TextEditingController();
    _model.facilityCodeFocusNode ??= FocusNode();

    _model.diagnosisCodeTextController ??= TextEditingController();
    _model.diagnosisCodeFocusNode ??= FocusNode();

    _model.departmentCodeTextController ??= TextEditingController();
    ...
    _model.pressTextController ??= TextEditingController();
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                ...
                                child: Visibility(
                                  visible:
                                      _model.dropDowDepartmentCallValue != null,
                                  child: Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        18.0, 0.0, 0.0, 0.0),
                                    child: Text(
                                      'Відділення для виклику лікаря',
                                      style: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                                            fontFamily: 'Rubik',
                              ...
                              Container(
                                ...
                                child: FlutterFlowDropDown<int>(
                                  controller: _model
                                          .dropDowDepartmentCallValueController ??=
                                  ...
                                  onChanged: (val) async {
                                    setState(() => _model
                                        .dropDowDepartmentCallValue = val);
                                    _model.departmentCall =
                                        _model.dropDowDepartmentCallValue;
                                    setState(() {});
                                  },
                                  height: 50.0,
                                  searchHintTextStyle:
                                  ...
                                  textStyle: FlutterFlowTheme.of(context)
                                      ...
                                      .override(
                                        fontFamily: 'Roboto',
                                        color: () {
                                          if ((_model.departmentCall == null) &&
                                              !_model.isDoctorCalled) {
                                            return FlutterFlowTheme.of(context)
                                                .tertiary;
                                          } else if ((_model.departmentCall ==
                                                  null) &&
                                              _model.isDoctorCalled) {
                                            return FlutterFlowTheme.of(context)
                                                .secondaryText;
                                        ...
                                        fontSize: _model.departmentCall == null
                                            ? 14.0
                                            : 16.0,
                                        letterSpacing: 0.0,
                                      ),
                                  hintText: 'Вкажіть відділення для виклику...',
                        ...
                        child: Builder(
                          builder: (context) => Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: (_model.dropDowDepartmentCallValue ==
                                      null)
                                  ? null
                                  : () async {
                                              ...
                                              child: Container(
                                                width:
                                                    MediaQuery.sizeOf(context)
                                                            .width *
                                                        0.9,
                                                child: CallDoctorQWidget(
                                                  department: _model
                                                      .dropDowDepartmentCallValue!,
                                                  conf: () async {
                                                    await LogDoctorRecCallsTable()
                                                        .insert({
                                                      'department': _model
                                                          .dropDowDepartmentCallValue,
                                                    });
                              ...
                              options: FFButtonOptions(
                                ...
                                borderRadius: BorderRadius.circular(8.0),
                                disabledColor: _model.isDoctorCalled == true
                        ...
                        child: Padding(
                          ...
                          child: TextFormField(
                            ...
                            onChanged: (_) => EasyDebounce.debounce(
                              ...
                              Duration(milliseconds: 2000),
                              () async {
                                if (_model.formKey22.currentState == null ||
                                    !_model.formKey22.currentState!
                                        .validate()) {
                                  return;
                                }
                              },
                          ...
                          child: Padding(
                            ...
                            child: TextFormField(
                              ...
                              onChanged: (_) => EasyDebounce.debounce(
                                ...
                                Duration(milliseconds: 2000),
                                () async {
                                  if (_model.formKey25.currentState == null ||
                                      !_model.formKey25.currentState!
                                          .validate()) {
                                    return;
                                  }
                                },
                          ...
                          child: Padding(
                            ...
                            child: TextFormField(
                              ...
                              onChanged: (_) => EasyDebounce.debounce(
                                ...
                                Duration(milliseconds: 2000),
                                () async {
                                  if (_model.formKey23.currentState == null ||
                                      !_model.formKey23.currentState!
                                          .validate()) {
                                    return;
                                  }
                                },
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  onChanged: (_) => EasyDebounce.debounce(
                                    ...
                                    Duration(milliseconds: 2000),
                                    () async {
                                      if (_model.formKey20.currentState ==
                                              null ||
                                          !_model.formKey20.currentState!
                                              .validate()) {
                                        return;
                                      }
                                    },
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  onChanged: (_) => EasyDebounce.debounce(
                                    ...
                                    Duration(milliseconds: 2000),
                                    () async {
                                      if (_model.formKey26.currentState ==
                                              null ||
                                          !_model.formKey26.currentState!
                                              .validate()) {
                                        return;
                                      }
                                    },
                          ...
                          child: Padding(
                            ...
                            child: TextFormField(
                              ...
                              onChanged: (_) => EasyDebounce.debounce(
                                ...
                                Duration(milliseconds: 2000),
                                () async {
                                  if (_model.formKey21.currentState == null ||
                                      !_model.formKey21.currentState!
                                          .validate()) {
                                    return;
                                  }
                                },
                        ...
                        child: Form(
                          ...
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 30.0, 0.0, 0.0),
                            child: TextFormField(
                              controller: _model.facilityCodeTextController,
                              focusNode: _model.facilityCodeFocusNode,
                              onChanged: (_) => EasyDebounce.debounce(
                                '_model.facilityCodeTextController',
                                Duration(milliseconds: 2000),
                                () async {
                                  if (_model.formKey19.currentState == null ||
                                      !_model.formKey19.currentState!
                                          .validate()) {
                                    return;
                                  }
                                },
                                              ...
                                              child: Container(
                                                width:
                                                    MediaQuery.sizeOf(context)
                                                            .width *
                                                        0.9,
                                                child: SearchingDiagnosesWidget(
                                                  setData: (code,
                                                      description) async {
                                                    _model.diagnosis =
                                                        description;
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(),
                              child: Visibility(
                                visible: _model.dropDowDepartmentValue != null,
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      18.0, 0.0, 0.0, 0.0),
                                  child: Text(
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              child: Visibility(
                                visible:
                                    _model.dropDowPlanOrUrgentValue != null,
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      18.0, 0.0, 0.0, 0.0),
                                  child: Text(
                            ...
                            Container(
                              ...
                              child: FlutterFlowDropDown<bool>(
                                ...
                                fillColor: _model.mouseRegionHovered7!
                                    ? Color(0xFFF0F1F3)
                                    : FlutterFlowTheme.of(context)
                                        .otherBackground,
                                elevation: 2.0,
                            ...
                            child: Form(
                              ...
                              child: Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 30.0, 0.0, 0.0),
                                child: TextFormField(
                                  controller: _model.temperatureTextController,
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  onChanged: (_) => EasyDebounce.debounce(
                                    ...
                                    Duration(milliseconds: 2000),
                                    () async {
                                      if (_model.formKey24.currentState ==
                                              null ||
                                          !_model.formKey24.currentState!
                                              .validate()) {
                                        return;
                                      }
                                    },
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                ...
                                child: Visibility(
                                  visible:
                                      _model.dropDownBloodGroupValue != null &&
                              ...
                              Container(
                                ...
                                child: FlutterFlowDropDown<String>(
                                      ...
                                      .override(
                                        ...
                                        color: _model.dropDownBloodGroupValue ==
                                            ...
                                            ? FlutterFlowTheme.of(context)
                                                .primaryText
                                            : FlutterFlowTheme.of(context).info,
                                        fontSize: _model.dropDownBloodGroupValue ==
                                                    null ||
                                                _model.dropDownBloodGroupValue ==
                                                    ''
                                            ? 14.0
                                  ...
                                  fillColor: _model.mouseRegionHovered8!
                                      ? Color(0xFFF0F1F3)
                                      : FlutterFlowTheme.of(context)
                                          .otherBackground,
                                  elevation: 2.0,
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: FlutterFlowDropDown<String>(
                                  controller:
                                      _model.dropDownBloodRhValueController ??=
                                          FormFieldController<String>(
                                    _model.dropDownBloodRhValue ??=
                                        columnPatientsRow?.bloodRhesusFactor,
                                  ),
                                  ...
                                  fillColor: _model.mouseRegionHovered9!
                                      ? Color(0xFFF0F1F3)
                                      : FlutterFlowTheme.of(context)
                                          .otherBackground,
                                  elevation: 2.0,
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    onChanged: (_) => EasyDebounce.debounce(
                                      ...
                                      Duration(milliseconds: 2000),
                                      () async {
                                        if (_model.formKey27.currentState ==
                                                null ||
                                            !_model.formKey27.currentState!
                                                .validate()) {
                                          return;
                                        }
                                      },
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: FlutterFlowDropDown<String>(
                                    controller: _model
                                            .dropDownInvalidValueController ??=
                                        FormFieldController<String>(
                                      _model.dropDownInvalidValue ??=
                                    ...
                                    fillColor: _model.mouseRegionHovered10!
                                        ? Color(0xFFF0F1F3)
                                        : FlutterFlowTheme.of(context)
                                            .otherBackground,
                                    elevation: 2.0,
                            ...
                            children: [
                              Padding(
                                ...
                                child: Icon(
                                  ...
                                  color:
                                      _model.isIncapacityCertificateNeed == true
                                          ? FlutterFlowTheme.of(context).info
                                          : FlutterFlowTheme.of(context)
                                              .secondaryText,
                                  size: 24.0,
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            if (_model.formKey16.currentState == null ||
                                !_model.formKey16.currentState!.validate()) {
                              return;
                            }
                            if (_model.dropDowDepartmentValue == null) {
                              return;
                            }
                            if (widget!.patientID != null &&
                              ...
                              await PatientsTable().update(
                                data: {
                                  ...
                                  'vasermanReactionDate': supaSerialize<
                                          DateTime>(
                              ...
                              _model.newPatient = await PatientsTable().insert({
                                'gender': _model.dropDownGenderValue,
                                'patientFirstName':
                                    _model.firstNameTextController.text,
                                'patientLastName':
                              ...
                              await AdmissionsTable().insert({
                                'patientID': _model.newPatient?.id,
                                'isHospitalityThisYear':
                                    _model.dropDowHospFirstOrNotValue,
                                'isHospitality30Days': _model.isHospAgain,
                                'referalClinicName':
                            ...
                            await showDialog(
                              ...
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  title: Text('Новий випадок успішно створено'),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
