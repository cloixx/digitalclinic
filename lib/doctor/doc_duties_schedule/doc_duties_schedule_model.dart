...
import 'dart:math';
import 'doc_duties_schedule_widget.dart' show DocDutiesScheduleWidget;
...
class DocDutiesScheduleModel extends FlutterFlowModel<DocDutiesScheduleWidget> {
  ///  State fields for stateful widgets in this page.

  final unfocusNode = FocusNode();
  // Stores action output result for [Backend Call - Query Rows] action in doc_DutiesSchedule widget.
