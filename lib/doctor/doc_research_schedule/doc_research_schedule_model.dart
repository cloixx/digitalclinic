...
import 'dart:math';
import 'doc_research_schedule_widget.dart' show DocResearchScheduleWidget;
...
class DocResearchScheduleModel
    extends FlutterFlowModel<DocResearchScheduleWidget> {
  ///  State fields for stateful widgets in this page.

  final unfocusNode = FocusNode();
  // Stores action output result for [Backend Call - Query Rows] action in doc_ResearchSchedule widget.
