...
import 'doc_drawer_model.dart';
export 'doc_drawer_model.dart';
...
class _DocDrawerWidgetState extends State<DocDrawerWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DocDrawerModel());
                            ...
                            children: [
                              ...
                              MouseRegion(
                                ...
                                child: InkWell(
                                  ...
                                  highlightColor: Colors.transparent,
                                  onTap: () async {
                                    context.pushNamed('doc_SurgeriesSchedule');
                                  },
                                  child: AnimatedContainer(
                                    duration: Duration(milliseconds: 200),
                                    curve: Curves.easeInOut,
