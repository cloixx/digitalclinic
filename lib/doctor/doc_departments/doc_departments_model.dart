...
import 'dart:math';
import 'doc_departments_widget.dart' show DocDepartmentsWidget;
...
class DocDepartmentsModel extends FlutterFlowModel<DocDepartmentsWidget> {
  ///  State fields for stateful widgets in this page.

  final unfocusNode = FocusNode();
  // Stores action output result for [Backend Call - Query Rows] action in doc_Departments widget.
