...
import 'dart:math';
import 'doc_a_i_widget.dart' show DocAIWidget;
...
class DocAIModel extends FlutterFlowModel<DocAIWidget> {
  ///  State fields for stateful widgets in this page.

  final unfocusNode = FocusNode();
  // Stores action output result for [Backend Call - Query Rows] action in doc_AI widget.
