...
import 'doc_a_i_model.dart';
export 'doc_a_i_model.dart';

class DocAIWidget extends StatefulWidget {
  const DocAIWidget({super.key});

  @override
  State<DocAIWidget> createState() => _DocAIWidgetState();
}

class _DocAIWidgetState extends State<DocAIWidget>
    with TickerProviderStateMixin {
  late DocAIModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DocAIModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<PDoctorsRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PDoctorsRow> docAIPDoctorsRowList = snapshot.data!;

        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final docAIPDoctorsRow =
            docAIPDoctorsRowList.isNotEmpty ? docAIPDoctorsRowList.first : null;
