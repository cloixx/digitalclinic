...
import 'rel_drawer_model.dart';
export 'rel_drawer_model.dart';

class RelDrawerWidget extends StatefulWidget {
  const RelDrawerWidget({
    super.key,
  ...
  final RelativesRow? userData;

  @override
  State<RelDrawerWidget> createState() => _RelDrawerWidgetState();
}

class _RelDrawerWidgetState extends State<RelDrawerWidget> {
  late RelDrawerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RelDrawerModel());
