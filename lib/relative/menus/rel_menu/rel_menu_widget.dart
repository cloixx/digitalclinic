...
import 'rel_menu_model.dart';
export 'rel_menu_model.dart';

class RelMenuWidget extends StatefulWidget {
  const RelMenuWidget({
    super.key,
  ...
  @override
  State<RelMenuWidget> createState() => _RelMenuWidgetState();
}

class _RelMenuWidgetState extends State<RelMenuWidget> {
  late RelMenuModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RelMenuModel());
