...
import 'head_drawer_model.dart';
export 'head_drawer_model.dart';

class HeadDrawerWidget extends StatefulWidget {
  const HeadDrawerWidget({
    super.key,
  ...
  final PDoctorsRow? userData;

  @override
  State<HeadDrawerWidget> createState() => _HeadDrawerWidgetState();
}

class _HeadDrawerWidgetState extends State<HeadDrawerWidget> {
  late HeadDrawerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HeadDrawerModel());
