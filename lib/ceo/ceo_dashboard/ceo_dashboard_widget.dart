...
export 'ceo_dashboard_model.dart';

class CeoDashboardWidget extends StatefulWidget {
  const CeoDashboardWidget({super.key});

  @override
  State<CeoDashboardWidget> createState() => _CeoDashboardWidgetState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<PCeoRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PCeoRow> ceoDashboardPCeoRowList = snapshot.data!;

        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final ceoDashboardPCeoRow = ceoDashboardPCeoRowList.isNotEmpty
            ? ceoDashboardPCeoRowList.first
            : null;
          ...
          child: Scaffold(
            ...
            drawer: Container(
              ...
              child: Drawer(
                elevation: 16.0,
                child: wrapWithModel(
                  model: _model.ceoDrawerModel,
                  updateCallback: () => setState(() {}),
                  child: CeoDrawerWidget(
                    selectedPage: 1,
                    userData: ceoDashboardPCeoRow!,
                  ),
                ),
              ),
            ),
