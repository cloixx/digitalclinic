...
import 'ceo_menu_model.dart';
export 'ceo_menu_model.dart';

class CeoMenuWidget extends StatefulWidget {
  const CeoMenuWidget({
    super.key,
  ...
  @override
  State<CeoMenuWidget> createState() => _CeoMenuWidgetState();
}

class _CeoMenuWidgetState extends State<CeoMenuWidget> {
  late CeoMenuModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CeoMenuModel());
