...
import 'ceo_drawer_model.dart';
export 'ceo_drawer_model.dart';

class CeoDrawerWidget extends StatefulWidget {
  const CeoDrawerWidget({
    super.key,
  ...
  @override
  State<CeoDrawerWidget> createState() => _CeoDrawerWidgetState();
}

class _CeoDrawerWidgetState extends State<CeoDrawerWidget> {
  late CeoDrawerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CeoDrawerModel());
