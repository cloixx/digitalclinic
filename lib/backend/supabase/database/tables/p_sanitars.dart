...
class PSanitarsTable extends SupabaseTable<PSanitarsRow> {
  @override
  String get tableName => 'p_sanitars';

  @override
  PSanitarsRow createRow(Map<String, dynamic> data) => PSanitarsRow(data);
}

class PSanitarsRow extends SupabaseDataRow {
  PSanitarsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => PSanitarsTable();
