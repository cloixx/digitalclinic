...
class PNursesTable extends SupabaseTable<PNursesRow> {
  @override
  String get tableName => 'p_nurses';

  @override
  PNursesRow createRow(Map<String, dynamic> data) => PNursesRow(data);
}

class PNursesRow extends SupabaseDataRow {
  PNursesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => PNursesTable();
