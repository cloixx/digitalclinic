...
class RelativesTable extends SupabaseTable<RelativesRow> {
  @override
  String get tableName => 'relatives';

  @override
  RelativesRow createRow(Map<String, dynamic> data) => RelativesRow(data);
}

class RelativesRow extends SupabaseDataRow {
  RelativesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => RelativesTable();
