...
class PReceptionistsTable extends SupabaseTable<PReceptionistsRow> {
  @override
  String get tableName => 'p_receptionists';

  @override
  PReceptionistsRow createRow(Map<String, dynamic> data) =>
      PReceptionistsRow(data);
}

class PReceptionistsRow extends SupabaseDataRow {
  PReceptionistsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => PReceptionistsTable();
