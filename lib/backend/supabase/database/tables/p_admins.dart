...
class PAdminsTable extends SupabaseTable<PAdminsRow> {
  @override
  String get tableName => 'p_admins';

  @override
  PAdminsRow createRow(Map<String, dynamic> data) => PAdminsRow(data);
}

class PAdminsRow extends SupabaseDataRow {
  PAdminsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => PAdminsTable();
