...
import 's_nur_menu_model.dart';
export 's_nur_menu_model.dart';

class SNurMenuWidget extends StatefulWidget {
  const SNurMenuWidget({
    super.key,
  ...
  @override
  State<SNurMenuWidget> createState() => _SNurMenuWidgetState();
}

class _SNurMenuWidgetState extends State<SNurMenuWidget> {
  late SNurMenuModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SNurMenuModel());
