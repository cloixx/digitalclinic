...
import 's_nur_drawer_model.dart';
export 's_nur_drawer_model.dart';

class SNurDrawerWidget extends StatefulWidget {
  const SNurDrawerWidget({
    super.key,
  ...
  @override
  State<SNurDrawerWidget> createState() => _SNurDrawerWidgetState();
}

class _SNurDrawerWidgetState extends State<SNurDrawerWidget> {
  late SNurDrawerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SNurDrawerModel());
