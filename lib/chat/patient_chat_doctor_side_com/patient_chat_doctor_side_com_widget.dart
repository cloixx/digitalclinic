...
import 'patient_chat_doctor_side_com_model.dart';
export 'patient_chat_doctor_side_com_model.dart';

class PatientChatDoctorSideComWidget extends StatefulWidget {
  const PatientChatDoctorSideComWidget({
    super.key,
  ...
  @override
  State<PatientChatDoctorSideComWidget> createState() =>
      _PatientChatDoctorSideComWidgetState();
}

class _PatientChatDoctorSideComWidgetState
    extends State<PatientChatDoctorSideComWidget>
    with TickerProviderStateMixin {
  late PatientChatDoctorSideComModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PatientChatDoctorSideComModel());
