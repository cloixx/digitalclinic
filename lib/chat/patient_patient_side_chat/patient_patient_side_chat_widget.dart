...
import 'patient_patient_side_chat_model.dart';
export 'patient_patient_side_chat_model.dart';

class PatientPatientSideChatWidget extends StatefulWidget {
  const PatientPatientSideChatWidget({
    super.key,
    this.opponentID,
  ...
  @override
  State<PatientPatientSideChatWidget> createState() =>
      _PatientPatientSideChatWidgetState();
}

class _PatientPatientSideChatWidgetState
    extends State<PatientPatientSideChatWidget> {
  late PatientPatientSideChatModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PatientPatientSideChatModel());
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: Padding(
          ...
          child: wrapWithModel(
            model: _model.patientChatPatientSideComModel,
            updateCallback: () => setState(() {}),
            child: PatientChatPatientSideComWidget(
