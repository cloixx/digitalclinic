...
import 'pat_examination_model.dart';
export 'pat_examination_model.dart';

class PatExaminationWidget extends StatefulWidget {
  const PatExaminationWidget({super.key});

  @override
  State<PatExaminationWidget> createState() => _PatExaminationWidgetState();
}

class _PatExaminationWidgetState extends State<PatExaminationWidget>
    with TickerProviderStateMixin {
  late PatExaminationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PatExaminationModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<PatientsRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PatientsRow> patExaminationPatientsRowList = snapshot.data!;

        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final patExaminationPatientsRow =
            patExaminationPatientsRowList.isNotEmpty
                ? patExaminationPatientsRowList.first
                : null;
              ...
              child: Drawer(
                ...
                child: wrapWithModel(
                  ...
                  child: PatDrawerWidget(
                    selectedPage: 3,
                    patientData: patExaminationPatientsRow!,
                  ),
                ),
              ),
            ),
