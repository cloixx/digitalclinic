...
import 'pat_diary_model.dart';
export 'pat_diary_model.dart';

class PatDiaryWidget extends StatefulWidget {
  const PatDiaryWidget({super.key});

  @override
  State<PatDiaryWidget> createState() => _PatDiaryWidgetState();
}

class _PatDiaryWidgetState extends State<PatDiaryWidget>
    with TickerProviderStateMixin {
  late PatDiaryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PatDiaryModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<PatientsRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PatientsRow> patDiaryPatientsRowList = snapshot.data!;

        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final patDiaryPatientsRow = patDiaryPatientsRowList.isNotEmpty
            ? patDiaryPatientsRowList.first
            : null;
              ...
              child: Drawer(
                ...
                child: wrapWithModel(
                  ...
                  child: PatDrawerWidget(
                    selectedPage: 7,
                    patientData: patDiaryPatientsRow!,
                  ),
                ),
              ),
            ),
