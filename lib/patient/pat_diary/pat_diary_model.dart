...
import 'dart:math';
import 'pat_diary_widget.dart' show PatDiaryWidget;
...
class PatDiaryModel extends FlutterFlowModel<PatDiaryWidget> {
  ...
  // Stores action output result for [Backend Call - Query Rows] action in pat_Diary widget.
