...
import 'pat_dashboard_copy_model.dart';
export 'pat_dashboard_copy_model.dart';

class PatDashboardCopyWidget extends StatefulWidget {
  const PatDashboardCopyWidget({super.key});

  @override
  State<PatDashboardCopyWidget> createState() => _PatDashboardCopyWidgetState();
}

class _PatDashboardCopyWidgetState extends State<PatDashboardCopyWidget>
    with TickerProviderStateMixin {
  late PatDashboardCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PatDashboardCopyModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<PatientsRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PatientsRow> patDashboardCopyPatientsRowList = snapshot.data!;

        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final patDashboardCopyPatientsRow =
            patDashboardCopyPatientsRowList.isNotEmpty
                ? patDashboardCopyPatientsRowList.first
                : null;
              ...
              child: Drawer(
                ...
                child: wrapWithModel(
                  ...
                  child: PatDrawerWidget(
                    selectedPage: 2,
                    patientData: patDashboardCopyPatientsRow!,
                  ),
                ),
              ),
            ),
