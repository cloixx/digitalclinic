...
import 'dart:math';
import 'pat_dashboard_copy_widget.dart' show PatDashboardCopyWidget;
...
class PatDashboardCopyModel extends FlutterFlowModel<PatDashboardCopyWidget> {
  ...
  // Stores action output result for [Backend Call - Query Rows] action in pat_DashboardCopy widget.
