...
import 'dart:math';
import 'pat_call_widget.dart' show PatCallWidget;
...
class PatCallModel extends FlutterFlowModel<PatCallWidget> {
  ...
  // Stores action output result for [Backend Call - Query Rows] action in pat_Call widget.
