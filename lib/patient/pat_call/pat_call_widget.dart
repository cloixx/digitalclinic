...
import 'pat_call_model.dart';
export 'pat_call_model.dart';

class PatCallWidget extends StatefulWidget {
  const PatCallWidget({super.key});

  @override
  State<PatCallWidget> createState() => _PatCallWidgetState();
}

class _PatCallWidgetState extends State<PatCallWidget>
    with TickerProviderStateMixin {
  late PatCallModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PatCallModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<PatientsRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PatientsRow> patCallPatientsRowList = snapshot.data!;

        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final patCallPatientsRow = patCallPatientsRowList.isNotEmpty
            ? patCallPatientsRowList.first
            : null;
              ...
              child: Drawer(
                ...
                child: wrapWithModel(
                  ...
                  child: PatDrawerWidget(
                    selectedPage: 1,
                    patientData: patCallPatientsRow!,
                  ),
                ),
              ),
            ),
