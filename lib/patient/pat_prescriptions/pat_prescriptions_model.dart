...
import 'dart:math';
import 'pat_prescriptions_widget.dart' show PatPrescriptionsWidget;
...
class PatPrescriptionsModel extends FlutterFlowModel<PatPrescriptionsWidget> {
  ...
  // Stores action output result for [Backend Call - Query Rows] action in pat_Prescriptions widget.
