...
import 'pat_prescriptions_model.dart';
export 'pat_prescriptions_model.dart';

class PatPrescriptionsWidget extends StatefulWidget {
  const PatPrescriptionsWidget({super.key});

  @override
  State<PatPrescriptionsWidget> createState() => _PatPrescriptionsWidgetState();
}

class _PatPrescriptionsWidgetState extends State<PatPrescriptionsWidget>
    with TickerProviderStateMixin {
  late PatPrescriptionsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PatPrescriptionsModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<PatientsRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PatientsRow> patPrescriptionsPatientsRowList = snapshot.data!;

        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final patPrescriptionsPatientsRow =
            patPrescriptionsPatientsRowList.isNotEmpty
                ? patPrescriptionsPatientsRowList.first
                : null;
              ...
              child: Drawer(
                ...
                child: wrapWithModel(
                  ...
                  child: PatDrawerWidget(
                    selectedPage: 4,
                    patientData: patPrescriptionsPatientsRow!,
                  ),
                ),
              ),
            ),
