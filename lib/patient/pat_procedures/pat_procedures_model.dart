...
import 'dart:math';
import 'pat_procedures_widget.dart' show PatProceduresWidget;
...
class PatProceduresModel extends FlutterFlowModel<PatProceduresWidget> {
  ...
  // Stores action output result for [Backend Call - Query Rows] action in pat_Procedures widget.
