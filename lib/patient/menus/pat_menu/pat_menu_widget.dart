...
import 'pat_menu_model.dart';
export 'pat_menu_model.dart';

class PatMenuWidget extends StatefulWidget {
  const PatMenuWidget({
    super.key,
  ...
  @override
  State<PatMenuWidget> createState() => _PatMenuWidgetState();
}

class _PatMenuWidgetState extends State<PatMenuWidget> {
  late PatMenuModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PatMenuModel());
