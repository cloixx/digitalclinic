...
import 'user_profile_item_searching_model.dart';
export 'user_profile_item_searching_model.dart';

class UserProfileItemSearchingWidget extends StatefulWidget {
  const UserProfileItemSearchingWidget({
    super.key,
    required this.userRow,
  });

  final UserProfilesDataStruct? userRow;

  @override
  State<UserProfileItemSearchingWidget> createState() =>
      _UserProfileItemSearchingWidgetState();
}

class _UserProfileItemSearchingWidgetState
    extends State<UserProfileItemSearchingWidget> {
  late UserProfileItemSearchingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserProfileItemSearchingModel());
