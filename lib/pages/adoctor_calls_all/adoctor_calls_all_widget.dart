...
import 'adoctor_calls_all_model.dart';
export 'adoctor_calls_all_model.dart';

class AdoctorCallsAllWidget extends StatefulWidget {
  const AdoctorCallsAllWidget({super.key});

  @override
  State<AdoctorCallsAllWidget> createState() => _AdoctorCallsAllWidgetState();
}

class _AdoctorCallsAllWidgetState extends State<AdoctorCallsAllWidget> {
  late AdoctorCallsAllModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdoctorCallsAllModel());
                                ...
                                return InkWell(
                                  ...
                                  child: wrapWithModel(
                                    ...
                                    child: PatientItemSearchingWidget(
                                      key: Key(
                                        'Key37a_${userDataIndex.toString()}',
                                      ),
