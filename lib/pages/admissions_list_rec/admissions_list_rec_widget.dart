...
import 'admissions_list_rec_model.dart';
export 'admissions_list_rec_model.dart';

class AdmissionsListRecWidget extends StatefulWidget {
  const AdmissionsListRecWidget({super.key});

  @override
  State<AdmissionsListRecWidget> createState() =>
      _AdmissionsListRecWidgetState();
}

class _AdmissionsListRecWidgetState extends State<AdmissionsListRecWidget> {
  late AdmissionsListRecModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdmissionsListRecModel());
