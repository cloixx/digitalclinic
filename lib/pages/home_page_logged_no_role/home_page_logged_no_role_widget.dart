...
import 'home_page_logged_no_role_model.dart';
export 'home_page_logged_no_role_model.dart';

class HomePageLoggedNoRoleWidget extends StatefulWidget {
  const HomePageLoggedNoRoleWidget({Key? key}) : super(key: key);

  @override
  _HomePageLoggedNoRoleWidgetState createState() =>
      _HomePageLoggedNoRoleWidgetState();
}

class _HomePageLoggedNoRoleWidgetState
    extends State<HomePageLoggedNoRoleWidget> {
  late HomePageLoggedNoRoleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomePageLoggedNoRoleModel());
