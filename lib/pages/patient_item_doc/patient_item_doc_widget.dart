...
import 'patient_item_doc_model.dart';
export 'patient_item_doc_model.dart';

class PatientItemDocWidget extends StatefulWidget {
  const PatientItemDocWidget({
    super.key,
  ...
  @override
  State<PatientItemDocWidget> createState() => _PatientItemDocWidgetState();
}

class _PatientItemDocWidgetState extends State<PatientItemDocWidget> {
  late PatientItemDocModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PatientItemDocModel());
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                context.pushNamed(
                                  'patient_DoctorSide_Chat',
                                  queryParameters: {
                                    'opponentID': serializeParam(
                                      widget!.userRow?.patientID,
                                      ParamType.String,
                                    ),
