...
import 'user_profile_com_model.dart';
export 'user_profile_com_model.dart';

class UserProfileComWidget extends StatefulWidget {
  const UserProfileComWidget({
    super.key,
  ...
  @override
  State<UserProfileComWidget> createState() => _UserProfileComWidgetState();
}

class _UserProfileComWidgetState extends State<UserProfileComWidget> {
  late UserProfileComModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserProfileComModel());
