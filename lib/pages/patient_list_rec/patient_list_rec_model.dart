...
import 'patient_list_rec_widget.dart' show PatientListRecWidget;
...
class PatientListRecModel extends FlutterFlowModel<PatientListRecWidget> {
  ...
  // Stores action output result for [Backend Call - API (searchPatientByParam serviceRole secret RLS)] action in patientList_rec widget.
