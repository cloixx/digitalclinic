...
import '/pages/new_patient_item_nur/new_patient_item_nur_widget.dart';
import '/pages/patient_item_nur/patient_item_nur_widget.dart';
import '/backend/schema/structs/index.dart';
...
import 'patient_list_nur_model.dart';
export 'patient_list_nur_model.dart';

class PatientListNurWidget extends StatefulWidget {
  const PatientListNurWidget({
    super.key,
  ...
  @override
  State<PatientListNurWidget> createState() => _PatientListNurWidgetState();
}

class _PatientListNurWidgetState extends State<PatientListNurWidget> {
  late PatientListNurModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PatientListNurModel());
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        if (_model.chambersWithNull.contains(_model.nullItem))
          Padding(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Builder(
                          builder: (context) {
                            final newPatient = _model.patientsList
                                .where((e) =>
                                    (e.chamberNumber == null) ||
                                    (e.chamberNumber == 0))
                                .toList();
                            ...
                            return ListView.builder(
                              ...
                              itemCount: newPatient.length,
                              itemBuilder: (context, newPatientIndex) {
                                final newPatientItem =
                                    newPatient[newPatientIndex];
                                return NewPatientItemNurWidget(
                                  key: Key(
                                      'Keyj39_${newPatientIndex}_of_${newPatient.length}'),
                                  userRow: newPatientItem,
                                );
                              },
                            );
                          },
                                      ...
                                      builder: (context) {
                                        ...
                                        return ListView.builder(
                                          ...
                                          itemBuilder:
                                            ...
                                            return PatientItemNurWidget(
                                              key: Key(
                                                  'Key8qd_${chamberInIndex}_of_${chamberIn.length}'),
