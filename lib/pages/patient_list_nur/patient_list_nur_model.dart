...
import 'patient_list_nur_widget.dart' show PatientListNurWidget;
import 'package:flutter/material.dart';
import 'package:flutter/scheduler.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:provider/provider.dart';

class PatientListNurModel extends FlutterFlowModel<PatientListNurWidget> {
  ...
  // Stores action output result for [Backend Call - API (patientInViewByDepartment serviceRole secret RLS)] action in patientList_nur widget.
