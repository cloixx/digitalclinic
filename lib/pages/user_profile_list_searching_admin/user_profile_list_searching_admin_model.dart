...
import 'user_profile_list_searching_admin_widget.dart'
    show UserProfileListSearchingAdminWidget;
...
class UserProfileListSearchingAdminModel
    extends FlutterFlowModel<UserProfileListSearchingAdminWidget> {
  ...
  // Stores action output result for [Backend Call - API (searchUserProfileByParam)] action in userProfileListSearchingAdmin widget.
  ...
  // Models for userProfileItemSearching dynamic component.
  late FlutterFlowDynamicModels<UserProfileItemSearchingModel>
      userProfileItemSearchingModels;

  @override
  void initState(BuildContext context) {
    userProfileItemSearchingModels =
        FlutterFlowDynamicModels(() => UserProfileItemSearchingModel());
  }
  ...
  void dispose() {
    ...
    userProfileItemSearchingModels.dispose();
  }
}
