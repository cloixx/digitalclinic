...
import '/pages/user_profile_com/user_profile_com_widget.dart';
...
import 'user_profile_list_searching_admin_model.dart';
export 'user_profile_list_searching_admin_model.dart';

class UserProfileListSearchingAdminWidget extends StatefulWidget {
  const UserProfileListSearchingAdminWidget({super.key});

  @override
  State<UserProfileListSearchingAdminWidget> createState() =>
      _UserProfileListSearchingAdminWidgetState();
}

class _UserProfileListSearchingAdminWidgetState
    extends State<UserProfileListSearchingAdminWidget> {
  late UserProfileListSearchingAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserProfileListSearchingAdminModel());
                            ...
                            Container(
                              ...
                              child: FlutterFlowDropDown<String>(
                                controller: _model.dropDownValueController ??=
                                  ...
                                  _model.dropDownValue ??= 'email',
                                ),
                                options:
                                    List<String>.from(['email', 'google_name']),
                                optionLabels: ['E-mail', 'Ім\'я в Google'],
                                onChanged: (val) async {
                                  ...
                                  _model.apiResultUsersProfilesRes =
                                      await SearchUserProfileByParamCall.call(
                                    searchString: _model.textController.text,
                                    columnName: _model.dropDownValue,
                                  );
                                      ...
                                      ? functions
                                          .sortingUsersByCreatedDateDecreasing(
                                              _model.userProfileData
                                                  .where((e) =>
                                                      e.roles.first == 'userIN')
                                                  .toList())
                                      : functions
                                          .sortingUsersByCreatedDateDecreasing(
                                              _model.userProfileData.toList()))
                                  ?.toList() ??
                              [])
                          .take(100)
                          .toList();
                        ...
                        itemBuilder: (context, userDataIndex) {
                          ...
                          return Builder(
                            builder: (context) => InkWell(
                              ...
                              child: wrapWithModel(
                                model: _model.userProfileItemSearchingModels
                                    .getModel(
                                ...
                                child: UserProfileItemSearchingWidget(
                                  key: Key(
                                    'Keyief_${userDataIndex.toString()}',
                                  ),
                                  userRow: userDataItem,
                                ),
                              ),
