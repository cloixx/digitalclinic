...
import 'patient_list_searching_widget.dart' show PatientListSearchingWidget;
...
class PatientListSearchingModel
    extends FlutterFlowModel<PatientListSearchingWidget> {
  ...
  // Stores action output result for [Backend Call - API (searchPatientByParam serviceRole secret RLS)] action in patientListSearching widget.
