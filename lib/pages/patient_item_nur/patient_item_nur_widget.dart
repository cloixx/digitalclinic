...
import 'patient_item_nur_model.dart';
export 'patient_item_nur_model.dart';

class PatientItemNurWidget extends StatefulWidget {
  const PatientItemNurWidget({
    super.key,
  ...
  @override
  State<PatientItemNurWidget> createState() => _PatientItemNurWidgetState();
}

class _PatientItemNurWidgetState extends State<PatientItemNurWidget> {
  late PatientItemNurModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PatientItemNurModel());
