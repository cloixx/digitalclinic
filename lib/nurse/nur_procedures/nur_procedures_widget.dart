...
import 'nur_procedures_model.dart';
export 'nur_procedures_model.dart';

class NurProceduresWidget extends StatefulWidget {
  const NurProceduresWidget({super.key});

  @override
  State<NurProceduresWidget> createState() => _NurProceduresWidgetState();
}

class _NurProceduresWidgetState extends State<NurProceduresWidget>
    with TickerProviderStateMixin {
  late NurProceduresModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NurProceduresModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<PNursesRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PNursesRow> nurProceduresPNursesRowList = snapshot.data!;

        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final nurProceduresPNursesRow = nurProceduresPNursesRowList.isNotEmpty
            ? nurProceduresPNursesRowList.first
            : null;
              ...
              child: Drawer(
                ...
                child: wrapWithModel(
                  ...
                  child: NurDrawerWidget(
                    selectedPage: 4,
                    userData: nurProceduresPNursesRow!,
                  ),
                ),
              ),
            ),
