...
import 'nur_departments_widget.dart' show NurDepartmentsWidget;
...
class NurDepartmentsModel extends FlutterFlowModel<NurDepartmentsWidget> {
  ...
  // Stores action output result for [Backend Call - Query Rows] action in nur_Departments widget.
