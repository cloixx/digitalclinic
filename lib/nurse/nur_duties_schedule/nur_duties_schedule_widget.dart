...
import 'nur_duties_schedule_model.dart';
export 'nur_duties_schedule_model.dart';

class NurDutiesScheduleWidget extends StatefulWidget {
  const NurDutiesScheduleWidget({super.key});

  @override
  State<NurDutiesScheduleWidget> createState() =>
      _NurDutiesScheduleWidgetState();
}

class _NurDutiesScheduleWidgetState extends State<NurDutiesScheduleWidget>
    with TickerProviderStateMixin {
  late NurDutiesScheduleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NurDutiesScheduleModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<PNursesRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PNursesRow> nurDutiesSchedulePNursesRowList = snapshot.data!;

        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final nurDutiesSchedulePNursesRow =
            nurDutiesSchedulePNursesRowList.isNotEmpty
                ? nurDutiesSchedulePNursesRowList.first
                : null;
              ...
              child: Drawer(
                ...
                child: wrapWithModel(
                  ...
                  child: NurDrawerWidget(
                    selectedPage: 6,
                    userData: nurDutiesSchedulePNursesRow!,
                  ),
                ),
              ),
            ),
