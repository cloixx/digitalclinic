...
import 'nur_research_schedule_model.dart';
export 'nur_research_schedule_model.dart';

class NurResearchScheduleWidget extends StatefulWidget {
  const NurResearchScheduleWidget({super.key});

  @override
  State<NurResearchScheduleWidget> createState() =>
      _NurResearchScheduleWidgetState();
}

class _NurResearchScheduleWidgetState extends State<NurResearchScheduleWidget>
    with TickerProviderStateMixin {
  late NurResearchScheduleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NurResearchScheduleModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<PNursesRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PNursesRow> nurResearchSchedulePNursesRowList = snapshot.data!;

        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final nurResearchSchedulePNursesRow =
            nurResearchSchedulePNursesRowList.isNotEmpty
                ? nurResearchSchedulePNursesRowList.first
                : null;
              ...
              child: Drawer(
                ...
                child: wrapWithModel(
                  ...
                  child: NurDrawerWidget(
                    selectedPage: 5,
                    userData: nurResearchSchedulePNursesRow!,
                  ),
                ),
              ),
            ),
