...
import 'nur_research_schedule_widget.dart' show NurResearchScheduleWidget;
...
class NurResearchScheduleModel
    extends FlutterFlowModel<NurResearchScheduleWidget> {
  ...
  // Stores action output result for [Backend Call - Query Rows] action in nur_ResearchSchedule widget.
