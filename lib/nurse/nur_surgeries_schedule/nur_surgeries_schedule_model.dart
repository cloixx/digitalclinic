...
import 'nur_surgeries_schedule_widget.dart' show NurSurgeriesScheduleWidget;
...
class NurSurgeriesScheduleModel
    extends FlutterFlowModel<NurSurgeriesScheduleWidget> {
  ...
  // Stores action output result for [Backend Call - Query Rows] action in nur_SurgeriesSchedule widget.
