...
import 'nur_drawer_model.dart';
export 'nur_drawer_model.dart';

class NurDrawerWidget extends StatefulWidget {
  const NurDrawerWidget({
    super.key,
  ...
  final PNursesRow? userData;

  @override
  State<NurDrawerWidget> createState() => _NurDrawerWidgetState();
}

class _NurDrawerWidgetState extends State<NurDrawerWidget> {
  late NurDrawerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NurDrawerModel());
                            ...
                            children: [
                              MouseRegion(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    context.pushNamed('nur_Departments');
                                  },
                                  child: AnimatedContainer(
                              ...
                              MouseRegion(
                                ...
                                child: InkWell(
                                  ...
                                  highlightColor: Colors.transparent,
                                  onTap: () async {
                                    context.pushNamed('nur_Procedures');
                                  },
                                  child: AnimatedContainer(
                                    duration: Duration(milliseconds: 200),
                                    curve: Curves.easeInOut,
                              ...
                              MouseRegion(
                                ...
                                child: InkWell(
                                  ...
                                  highlightColor: Colors.transparent,
                                  onTap: () async {
                                    context.pushNamed('nur_ResearchSchedule');
                                  },
                                  child: AnimatedContainer(
                                    duration: Duration(milliseconds: 200),
                                    curve: Curves.easeInOut,
                              ...
                              MouseRegion(
                                ...
                                child: InkWell(
                                  ...
                                  highlightColor: Colors.transparent,
                                  onTap: () async {
                                    context.pushNamed('nur_SurgeriesSchedule');
                                  },
                                  child: AnimatedContainer(
                                    duration: Duration(milliseconds: 200),
                                    curve: Curves.easeInOut,
                              ...
                              MouseRegion(
                                ...
                                child: InkWell(
                                  ...
                                  highlightColor: Colors.transparent,
                                  onTap: () async {
                                    context.pushNamed('nur_DutiesSchedule');
                                  },
                                  child: AnimatedContainer(
                                    duration: Duration(milliseconds: 200),
                                    curve: Curves.easeInOut,
