...
import 'nur_menu_model.dart';
export 'nur_menu_model.dart';

class NurMenuWidget extends StatefulWidget {
  const NurMenuWidget({
    super.key,
  ...
  @override
  State<NurMenuWidget> createState() => _NurMenuWidgetState();
}

class _NurMenuWidgetState extends State<NurMenuWidget> {
  late NurMenuModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NurMenuModel());
                              ...
                              children: [
                                ...
                                MouseRegion(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      context
                                          .pushNamed('nur_SurgeriesSchedule');
                                    },
                                    child: AnimatedContainer(
                                      duration: Duration(milliseconds: 200),
                                      curve: Curves.easeInOut,
