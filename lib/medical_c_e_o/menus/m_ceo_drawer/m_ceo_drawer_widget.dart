...
import 'm_ceo_drawer_model.dart';
export 'm_ceo_drawer_model.dart';

class MCeoDrawerWidget extends StatefulWidget {
  const MCeoDrawerWidget({
    super.key,
  ...
  final PCeoRow? userData;

  @override
  State<MCeoDrawerWidget> createState() => _MCeoDrawerWidgetState();
}

class _MCeoDrawerWidgetState extends State<MCeoDrawerWidget> {
  late MCeoDrawerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MCeoDrawerModel());
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  if ((FFAppState().userRolesList.length <=
                                          1) &&
                                      (FFAppState()
                                          .UserRolesListDataType
                                          .isNotEmpty))
